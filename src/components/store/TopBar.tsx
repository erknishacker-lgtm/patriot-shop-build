...
export function TopBar() {
  return (
    <div className="bg-brand-deep text-primary-foreground">
      <div className="mx-auto flex max-w-[1200px] items-center justify-center gap-6 px-4 py-2.5 text-center sm:justify-between">
        <p className="hidden items-center gap-2 text-xs font-semibold uppercase tracking-[0.14em] text-primary-foreground/80 sm:flex">
